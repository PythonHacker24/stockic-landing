            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="grid gap-6 md:grid-cols-2 md:gap-12">
                    ...
                    <div className="space-y-6">
                        <p>Reading news from random sources is an utter waste of time. You are bombarded with information you might never need, consuming your cognitive energy which needs to go in better stuff.</p>
                        <p>
